declare namespace UniNamespace {
    ...
    interface LivePlayerContextSnapshotOption {
         ...
         * 需要基础库： `2.25.0`
         *
         * 截取的源类型，有效值为 stream（截取视频源）、view（截取渲染后的画面）
         */
        sourceType?: string;
        /**
         * 接口调用成功的回调函数
...
interface Uni {
     ...
     */
    batchSetStorageSync(kvList: UniNamespace.KVArray): void;
    /**
     *
     * 需要基础库： `2.13.0`
     *
     ...
     */
    createBufferURL(buffer: ArrayBuffer | Int8Array | Uint8Array | Uint8ClampedArray | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array): void;
    /**
     *
     * 需要基础库： `2.12.0`
     *
